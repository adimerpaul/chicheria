...
<q-page class="q-pa-xs">
  <div class="row">
    ...
    <div class="col-12">
        ...
        <div class="col-12">
        <div class="row">
          <div class="col-6 col-sm-2 q-pa-xs"><q-input type="number" min=0 label="Efectivo" v-model="efectivo" disable outlined/></div>
          <div class="col-6 col-sm-2 q-pa-xs"><q-input type="text" label="Fisico" v-model="fisico" outlined/></div>
          <div class="col-6 col-sm-2 q-pa-xs"><q-input type="text" label="Observacion" v-model="obervacion" disable outlined/></div>
          <div class="col-6 col-sm-2 q-pa-xs"><q-input type="text" label="Estado material" v-model="material" outlined/></div>
          <div class="col-6 col-sm-2 q-pa-xs flex flex-center">

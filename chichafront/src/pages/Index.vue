...
<!--          <th class="">VENTAS</th>-->
        ...
        <tbody>
        <tr v-for="cliente in clienteCumple" :key="cliente.cliente">
...
<!--          <td>-->
<!--            <ul>-->
<!--              <li v-for="(venta, index) in cliente.ventas" :key="index" style="list-style: none;padding: 0; margin: 0;border: 0">-->
<!--                  {{ venta.fecha }} &nbsp;&nbsp;<b>TOTAL: &nbsp;</b>{{ venta.total }}-->
<!--              </li>-->
<!--            </ul>-->
<!--          </td>-->
        </tr>

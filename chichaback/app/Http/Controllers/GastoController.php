...
class GastoController extends Controller
{
    ...
    public function misgastos(Request  $request){
        ...
        //{
            ...
            return Gasto::with('glosa')->with('user')->whereNotIn('glosa_id',[2,15])->whereDate('fecha','>=',$request->fecha1)->whereDate('fecha','<=',$request->fecha2)->orderBy('id','desc')->get();
            else 
            return Gasto::with('glosa')->with('user')->whereNotIn('glosa_id',[2,15])->where('user_id',$request->user_id)->whereDate('fecha','>=',$request->fecha1)->whereDate('fecha','<=',$request->fecha2)->orderBy('id','desc')->get();
       // }
        //else

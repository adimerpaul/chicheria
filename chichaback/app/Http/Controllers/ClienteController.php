...
//        Cliente::create($request->all());
    ...
    public function aniver(){
        ...
        $cliente=DB::SELECT("SELECT *,MONTH(fechanac) as mes,DAY(fechanac) as dia from clientes
         where MONTH(fechanac)>=MONTH(CURDATE()) and MONTH(fechanac)<=MONTH('$fec') and DAY(fechanac)>=DAY(CURDATE()) and DAY(fechanac)<=DAY('$fec') and estado='ACTIVO' order by dia asc");
         return $cliente;
    }
